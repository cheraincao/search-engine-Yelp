...
3.Dataset business_tip is a combine version of yelp_academic_dataset_business and yelp_academic_dataset_tip from yelp dataset.
...
4.Run summary.py to generate static summary. Other files are using to import skipthoughts, which can be ignored.
